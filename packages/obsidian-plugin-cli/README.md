...
obsidian-plugin-cli/0.5.1 linux-x64 node-v14.16.1
...
_See code: [src/commands/build.ts](https://github.com/zephraph/obsidian-tools/blob/v0.5.1/src/commands/build.ts)_
...
_See code: [src/commands/dev.ts](https://github.com/zephraph/obsidian-tools/blob/v0.5.1/src/commands/dev.ts)_
