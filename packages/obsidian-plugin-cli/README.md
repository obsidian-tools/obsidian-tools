...
obsidian-plugin-cli/0.0.5 linux-x64 node-v14.15.5
...
_See code: [src/commands/build.ts](https://github.com/zephraph/obsidian-tools/blob/v0.0.5/src/commands/build.ts)_
...
_See code: [src/commands/dev.ts](https://github.com/zephraph/obsidian-tools/blob/v0.0.5/src/commands/dev.ts)_
