...
obsidian-plugin-cli/0.9.0 linux-x64 node-v14.21.2
...
_See code: [src/commands/build.ts](https://github.com/zephraph/obsidian-tools/blob/v0.9.0/src/commands/build.ts)_
...
_See code: [src/commands/dev.ts](https://github.com/zephraph/obsidian-tools/blob/v0.9.0/src/commands/dev.ts)_
...
_See code: [src/commands/install.ts](https://github.com/zephraph/obsidian-tools/blob/v0.9.0/src/commands/install.ts)_
<!-- commandsstop -->
